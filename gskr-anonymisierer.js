/* ==========================================================================
 * gskr-anonymisierer.js — PII-Tokenisierung (GSKR_ANON)
 * --------------------------------------------------------------------------
 * HERKUNFT : 1:1 extrahiert aus der internen Referenz-Fassung,
 *            Extraktion am 12.07.2026. Logik unveraendert (byte-gleich).
 * ZWECK    : Deterministische PII-Tokenisierung via HMAC-SHA256 aus dem Akten-Masterpasswort (E-Mail, Tel, IBAN, Steuernr., Firma, Name, Adresse) mit umkehrbarer Token-Map.
 * API      : GSKR_ANON: init, anonymisiereText, anonymisiereObjekt, deAnonymisiereText, deAnonymisiereObjekt, tokenFuer, mapExportieren, mapImportieren, statistik, reset, _STATE, _REGEX
 * ABHAENGIG: GSKR_CRYPTO (ZWINGEND fuer mapExportieren/mapImportieren) -> gskr-crypto.js muss VORHER geladen werden.
 *
